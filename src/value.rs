...
impl JNumber {
    ...
    /// # Examples
    /// ```
    /// use json::value::{JNumber, JsonValue};
    ///
...
mod tests {
    ...
    /// Tests the `to_string()` method of the `JsonValue` trait
    #[test]
    fn json_value_trait_to_string() {
